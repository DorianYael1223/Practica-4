...
public class Main {
    ...
    private static void pruebaDAOArchivo() {
        ...
        Usuario usuario1 = new Usuario(1, "John", "Doe", "john.doe@example.com", "password123");
    ...
    private static void pruebaDAOMySQL() {
        ...
        usuarioDAOMySQL.nom = "Jane";
        usuarioDAOMySQL.ap = "Doe";
        usuarioDAOMySQL.correo = "jane.doe@example.com";
        usuarioDAOMySQL.con = "password456";
        ...
        usuarioDAOMySQL.nom = "Jane Updated";
